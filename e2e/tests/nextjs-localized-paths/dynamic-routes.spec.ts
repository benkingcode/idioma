 ...
 *
 * IMPORTANT: These tests are expected to FAIL initially until pattern
 * matching is integrated into the Next.js middleware, Link, and LocaleHead.
 */
...
test.describe('Next.js Dynamic Routes - Localized Paths', () => {
  ...
  test.describe('Direct URL Access', () => {
    ...
    test('direct access to Spanish dynamic route works', async ({ page }) => {
      ...
      // Verify locale param is 'es' (translations not tested - no Babel plugin in fixture)
