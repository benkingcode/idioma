...
import { createAnthropicProvider, createOpenAIProvider, type TranslationProvider, type TranslationRequest } from './provider'
  ...
  describe('TranslationProvider interface', () => {
    it('defines the translate method', () => {
      const mockProvider: TranslationProvider = {
        name: 'mock',
        translate: vi.fn().mockResolvedValue([{ key: 'test', translation: 'translated' }]),
      }
