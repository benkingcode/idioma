...
import type { TranslationProvider, TranslatedMessage, TranslationRequest } from '../../ai/provider'

// Mock provider for testing
function createMockProvider(translations: Record<string, string>): TranslationProvider {
  return {
    name: 'mock',
