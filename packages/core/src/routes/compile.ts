...
export function generateRoutesModule(
  ...
  // Export patterns for segment-level matching with dynamic params
  // Both TanStack and Next.js need this for dynamic route matching
  lines.push(
  ...
  // TanStack: Export wrapper functions that use pattern matching
  if (isTanStackFramework(framework)) {
    lines.push(
